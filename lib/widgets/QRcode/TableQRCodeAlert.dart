                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  const Spacer(),
                                                  const Text(
                                                    "Scan mich!", textAlign: TextAlign.right,
                                                    style: TextStyle(fontSize: 7,
                                                        fontWeight: FontWeight.bold),),
                                                  const Text(
                                                    "Menu & Zahlen", textAlign: TextAlign.right,
                                                  ...
                                                  const Spacer(),
                                                  const Text(
                                                    "powered by", textAlign: TextAlign.right,
                                                    style: TextStyle(fontSize: 7,
                                                        fontWeight: FontWeight.bold),),
                                                  const Text("I N S P E R Y",
                                                    textAlign: TextAlign.center,
                                                    style: TextStyle(fontSize: 10,
                                                        fontWeight: FontWeight.bold),),
                                                  // SizedBox(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    await FlutterShare.share(
                                        title: 'Inspery Tisch Link',
                                        //text: 'Bestellen, Zahlen, Kellner rufen uns vieles mehr, gemeinsam über einen Link.',
                                        linkUrl: snapshot.data!,
                                        chooserTitle: 'Inspery: <a href="'+ snapshot.data! + '">Bestellen, Zahlen, Kellner rufen uns vieles mehr, gemeinsam über einen Link.</a>'
                                    );
                                  },
                                  child: Container(
                                      decoration: BoxDecoration(
                              ...
                              SizedBox(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    ...
                                    ConfigPrinter();
                                    print("connection " +
                                        (await _configPrinter.checkState()).toString());
                                    BlueThermalPrinter bluetooth = BlueThermalPrinter.instance;
                                    bluetooth.isConnected.then((isConnected) async {
                                      if (isConnected ?? false) {
                                        await bluetooth.printNewLine();
                                        await screenshotController2.capture().then((
                                        ...
                                        await screenshotController1.capture().then((
                                            Uint8List? image) async {
                                          await bluetooth.printImageBytes(image!);
                                          //QRImageAlert().show(image: image, context: context);
                                        }).catchError((onError) {
